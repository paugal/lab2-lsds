...
public class ExtendedSimplifiedTweet {
    ...
    public static Optional<ExtendedSimplifiedTweet> fromJson(String jsonStr) {
        ...
        JsonElement json_aux = ExtendedSimplifiedTweet.parser.parse(jsonStr);
        ...
        ExtendedSimplifiedTweet simplified_tweet = new ExtendedSimplifiedTweet(tweetId, text, userId, userName,
